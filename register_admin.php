<?php
session_start();
if (isset($_SESSION['type_mode']) and $_SESSION['type_mode'] == "Admin")
...
<body class="bg-gradient-primary">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Créer un compte Administrateur !</h1>
                            </div>
                            <form action="Données registre.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" name="adresse" class="form-control form-control-user" id="exampleAdress"
                                        placeholder="Entrez votre adresse">
                                </div>
                                <div>
                                    <input type="email" name="email" class="form-control form-control-user" id="exampleEmail"
                                ...
                                <div  class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="mot_de_passe_conf" class="form-control form-control-user"
    ...
    echo 'vous n\'etes pas autorisé à accéder à cette page seule les administrateurs ont le droit d\'y acceder ';
